  ...
  const handleClick = (message) => {
    ...
    switch (message) {
      ...
      case 'Message 2':
        ...
        break;
      case 'Message 3':
        botMessage = 'Reply message for Message 3';
        break;
      case 'Message 4':
        botMessage = 'Reply message for Message 4';
        break;
      case 'Message 5':
        botMessage = 'Reply message for Message 5';
        break;
      default:
        break;
    }
    ...
    <div className="App">
      ...
      <p>
        <ul style={{ listStyleType: "none"}}>
          <li>
            <button onClick={() => handleClick('Message 1')}>
            For frequently asked question 1 
            
             </button>
          </li>
          <li>
            <button onClick={() => handleClick('Message 2')}>
            For frequently asked question 2 
            </button>
          </li>
        
          <li>
            <button onClick={() => handleClick('Message 3')}>
            For frequently asked question 3 
            </button>
          </li>
          <li>
            <button onClick={() => handleClick('Message 4')}>
            For frequently asked question 4
            </button>
          </li>
          <li>
            <button onClick={() => handleClick('Message 5')}>
            For frequently asked question 5
            </button>
          </li>
        </ul>
      </p>
